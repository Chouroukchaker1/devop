...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                // Fetch fuel data
                const fuelResponse = await axios.get('http://localhost:8082/api/feuldata', axiosConfig);
                ...
                // Fetch flight data
                const flightResponse = await axios.get('http://localhost:8082/api/flightData', axiosConfig);
